...
export const env = createEnv({
	...
	server: {
		...
		PAYLOAD_SECRET: z.preprocess((str) => str || process.env.AUTH_SECRET, z.string().optional()),
	...
	runtimeEnv: {
		...
		CLERK_WEBHOOK_SECRET: process.env.CLERK_WEBHOOK_SECRET || process.env.AUTH_SECRET,
