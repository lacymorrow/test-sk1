...
const data: CardType[] = [
  ...
  },
  {
    title: "Text",
    content: (
      <p className="transform-gpu text-5xl tracking-tighter text-neutral-200 transition-colors group-hover:text-neutral-300 dark:text-neutral-700 dark:group-hover:text-neutral-600">
        H1
      </p>
    ),
  },
...
export function SimpleFeaturesCards() {
  return (
    <div className="flex">
      {data.map((card, index) => (
        <Card
