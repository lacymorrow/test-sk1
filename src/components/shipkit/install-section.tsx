	...
	return (
		<section className={"py-20 px-4 md:px-6 lg:px-8"}>
			<div className="max-w-4xl mx-auto text-center">
				...
				>
					<h1 className={cn("text-4xl md:text-6xl lg:text-8xl mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600 font-light", fontBungee.className)}>
						Bones CLI
					</h1>
				</motion.div>
				<motion.p
				...
				>
					...
					<div className="flex justify-center items-center font-mono text-sm sm:text-base md:text-lg break-all w-full relative">
						...
						<CopyButton value={installCommand} className='absolute right-0' successTitle='Command Copied!' successDescription='Paste it in your terminal to install Bones CLI.' />
					</div>
					<motion.div
				...
				>
					...
					<Link
						...
						className={cn(buttonVariants({ variant: "outline", size: "lg" }), "bg-gray-800 border-gray-600 text-gray-300 hover:bg-gray-700")}
				...
				<div className='mt-10 space-y-10'>
					<p className='text-muted-foreground [&>a]:text-blue-400 [&>a]:underline [&>a]:font-medium'>
						Run this command in your Next.js project after setting up <Link href={"https://ui.shadcn.com/docs/"}>ShadCN UI</Link>. If you would like to start with ShadCN pre-configured, check out the <Link href={routes.external.bones}>Bones Starter</Link>.
					</p>
					<p className='text-lg text-muted-foreground [&>a]:text-blue-400 [&>a]:underline [&>a]:font-medium'>
						Get more components and ship even faster with <Link href={routes.external.shipkit}>Shipkit</Link>.
					</p>
				</div>
			</div>
		</section>
