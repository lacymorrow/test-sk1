		...
		<section className="relative py-20">
			...
			<div className="relative z-10 container mx-auto px-4">
				<div className="max-w-3xl mx-auto text-center">
					<h2
						className={`text-3xl md:text-4xl font-bold mb-6 ${backgroundImage ? 'text-white' : 'text-gray-900'
							}`}
					>
						{title}
					</h2>
					<p
						className={`text-lg mb-8 ${backgroundImage ? 'text-gray-200' : 'text-gray-600'
							}`}
					>
						{description}
					</p>
