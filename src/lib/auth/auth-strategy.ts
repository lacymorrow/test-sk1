...
export function getAuthStrategy(): AuthStrategy {
	...
	const hasAuthJS =
		env.NEXT_PUBLIC_FEATURE_AUTH_RESEND_ENABLED === true ||
		env.NEXT_PUBLIC_FEATURE_AUTH_CREDENTIALS_ENABLED === true ||
		env.NEXT_PUBLIC_FEATURE_AUTH_GITHUB_ENABLED === true ||
		env.NEXT_PUBLIC_FEATURE_AUTH_GOOGLE_ENABLED === true ||
		env.NEXT_PUBLIC_FEATURE_AUTH_DISCORD_ENABLED === true ||
		env.NEXT_PUBLIC_FEATURE_AUTH_GITLAB_ENABLED === true ||
		env.NEXT_PUBLIC_FEATURE_AUTH_BITBUCKET_ENABLED === true ||
		env.NEXT_PUBLIC_FEATURE_AUTH_TWITTER_ENABLED === true;
