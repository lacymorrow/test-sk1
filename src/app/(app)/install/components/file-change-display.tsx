...
export const FileChangeDisplay = ({ changedFiles, onDownloadAll }: FileChangeDisplayProps) => {
    const [activeFile, setActiveFile] = useState<string>(changedFiles.length > 0 ? changedFiles[0].path : "");
                    ...
                    <Card>
                        <CardHeader className="py-3 flex flex-row items-center justify-between">
                            ...
                            <div className="flex space-x-2">
                                <Button variant="ghost" size="sm" onClick={() => selectedFile && downloadSingleFile(selectedFile)}>
                                    Download
                                </Button>
                                <Button variant="ghost" size="sm" onClick={() => selectedFile && copyToClipboard(selectedFile.content)}>
