		...
		<section className="relative min-h-screen flex items-center justify-center overflow-hidden">
			...
			<div className="absolute inset-0">
				...
				<div className="absolute inset-0 opacity-40">
					<div className="absolute top-1/4 -left-1/4 w-96 h-96 bg-gradient-to-br from-violet-400/20 to-transparent rounded-full blur-3xl animate-pulse"
						style={{ animationDuration: '6s' }} />
					<div className="absolute bottom-1/4 -right-1/4 w-96 h-96 bg-gradient-to-bl from-blue-400/20 to-transparent rounded-full blur-3xl animate-pulse"
			...
			<div className="container relative z-10 px-4 md:px-6 text-center">
				<div className="mx-auto max-w-4xl">
					...
					<div className="mb-8 flex justify-center">
						<Badge variant="outline" className="bg-white/90 dark:bg-slate-900/90 border-violet-200 dark:border-violet-800 text-violet-700 dark:text-violet-300 px-4 py-2 text-sm font-medium backdrop-blur-sm">
					...
					<p className="mx-auto mb-8 max-w-2xl text-xl md:text-2xl text-slate-600 dark:text-slate-300 leading-relaxed">
						The Next.js starter that actually works. <span className="text-slate-900 dark:text-white font-semibold">Auth, payments, database, and deployment</span> — all configured and ready to ship.
					</p>
