...
import { type WaitlistFormData, addToWaitlist } from "@/server/actions/waitlist-actions";
                            ...
                            <Card className="relative border-green-200 dark:border-green-800 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm">
                                <CardContent className="p-12">
                                    ...
                                    <p className="mb-8 text-green-700 dark:text-green-300 text-lg">
                                        You're now part of an exclusive group of developers who are tired of building the same things over and over.
                                        We'll keep you updated on our progress and give you first access when we launch.
                                    </p>
                                    <div className="grid gap-6 sm:grid-cols-2">
                                        <div className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900/10 rounded-lg">
                                            <Gift className="h-6 w-6 text-green-600 dark:text-green-400" />
                                            <div>
                                                <div className="font-semibold text-green-900 dark:text-green-100">50% OFF Forever</div>
                                                <div className="text-sm text-green-700 dark:text-green-300">Early access pricing locked in</div>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900/10 rounded-lg">
                                            <Sparkles className="h-6 w-6 text-green-600 dark:text-green-400" />
                                            <div>
                                                <div className="font-semibold text-green-900 dark:text-green-100">First Access</div>
                                                <div className="text-sm text-green-700 dark:text-green-300">Before public launch</div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="relative">
                        ...
                        <Card className="relative border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm">
                            <CardHeader className="text-center">
                                ...
                                <CardDescription>
                                    Just a few questions to help us prioritize features and make sure ShipKit fits your needs.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <p className="text-center text-xs text-slate-500 dark:text-slate-400">
                                        We'll only email you about ShipKit updates. No spam, no selling your data, no BS.
                                    </p>
                                </form>
                            </CardContent>
                        </Card>
